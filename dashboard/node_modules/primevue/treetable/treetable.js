...
this.primevue.treetable = (function (utils, api, Ripple, vue, Paginator) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (vue.openBlock(), vue.createBlock("td", {
        ...
        ($props.column.children && $props.column.children.body)
          ...
          : (vue.openBlock(), vue.createBlock("span", _hoisted_2, vue.toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp('field'))), 1))
      ], 6))
    }
    ...
    const _hoisted_2$2 = { class: "p-treetable-loading-overlay p-component-overlay" };
    const _hoisted_3 = {
      key: 1,
